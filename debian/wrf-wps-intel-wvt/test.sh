...
# Defaults
IMAGE="mullenkamp/wrf-wps-intel-wvt-ubuntu:2.2"
...
# WVT-specific files
check_file "/WRF/run/README.tracers"          "WVT README.tracers exists"
check_file "/WRF/run/namelist.input.tracers"  "WVT namelist.input.tracers exists"
